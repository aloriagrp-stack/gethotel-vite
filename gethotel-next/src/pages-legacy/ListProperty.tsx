            ...
            <main className="pb-20">
                ...
                <section className="relative px-6 pt-16 pb-40 md:pt-24 md:pb-56 overflow-hidden bg-transparent text-slate-900">
                    ...
                    <div className="max-w-6xl mx-auto relative z-10 text-center space-y-8">
                        ...
                        >
                            <Link to="/list-property/register" className="w-full sm:w-auto px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black text-xs uppercase tracking-[0.15em] transition-all hover:scale-105 shadow-[0_20px_40px_rgba(37,99,235,0.25)] flex items-center justify-center gap-3 border border-blue-500">
                ...
                <section className="py-24 px-6 max-w-4xl mx-auto text-center">
                    <div className="bg-brand-600 rounded-[40px] p-12 md:p-20 shadow-[0_20px_60px_rgba(79,70,229,0.2)] text-white relative overflow-hidden">
                        ...
                        <Link to="/list-property/register" className="inline-flex items-center gap-3 px-10 py-5 bg-white text-brand-600 rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-transform relative z-10">
