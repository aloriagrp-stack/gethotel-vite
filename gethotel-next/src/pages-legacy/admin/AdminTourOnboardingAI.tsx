...
export default function AdminTourOnboardingAI() {
    ...
    const handleParseJson = () => {
        ...
        try {
            ...
            const formatted = items.map((t, idx) => ({
                ...
                price: parseFloat(t.price || t.price_starting_inr || 15000),
                originalPrice: t.originalPrice || t.original_price ? parseFloat(t.originalPrice || t.original_price) : 20000,
                discountPercent: t.discountPercent || t.discount_percent || "25% OFF",
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-[#050505] text-neutral-100 p-6 space-y-8 font-sans">
            {/* Header Banner */}
                                ...
                                >
                                    ...
                                    <div className="p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#111111]/60">
                                        <div className="flex items-start gap-4">
                                            {/* Thumbnail */}
                                            <div className="w-24 h-20 rounded-xl overflow-hidden bg-neutral-900 border border-[#222] shrink-0 relative">
                                                {tour.image ? (
                                                    <img
                                                        src={tour.image}
                                                        alt={tour.title}
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            type="number"
                                                            value={tour.price}
                                                            onChange={(e) => updateTourField(tour.id, "price", parseFloat(e.target.value) || 0)}
                                                            className="w-full bg-[#141414] border border-[#262626] rounded-xl px-3 py-2 text-xs font-semibold text-emerald-400 focus:outline-none focus:border-emerald-500"
                                                        />
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => updateTourField(tour.id, "originalPrice", parseFloat(e.target.value) || null)}
                                                            className="w-full bg-[#141414] border border-[#262626] rounded-xl px-3 py-2 text-xs font-semibold text-neutral-300 focus:outline-none focus:border-emerald-500"
                                                        />
                                                    </div>

                                                    <div>
                                                        <label className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest mb-1 block">
                                                            Discount Badge (e.g. 24% OFF)
                                                        </label>
                                                        <input
                                                            type="text"
                                                            value={tour.discountPercent || ""}
                                                            onChange={(e) => updateTourField(tour.id, "discountPercent", e.target.value)}
                                                            className="w-full bg-[#141414] border border-[#262626] rounded-xl px-3 py-2 text-xs font-semibold text-amber-400 focus:outline-none focus:border-emerald-500"
                                                        />
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full bg-[#141414] border border-[#262626] rounded-xl px-3 py-2 text-xs font-mono text-emerald-300 focus:outline-none focus:border-emerald-500"
                                                    />
                                                </div>
