                    ...
                    <div className="bg-white w-full max-w-md rounded-none shadow-2xl overflow-hidden animate-slide-up">
                        <form onSubmit={handleBulkUpdate}>
                            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                                <div>
                                    <span className="text-[9px] font-black text-blue-600 uppercase tracking-widest">Inventory Management</span>
                                    <h2 className="text-lg font-black text-slate-900 tracking-tight">Bulk Block/Unblock</h2>
                                </div>
                                <button type="button" onClick={() => setIsBulkModalOpen(false)} className="w-8 h-8 bg-white border border-slate-200 rounded-none flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer">
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
                            ...
                            <div className="p-6 space-y-4">
                                <div className="space-y-1.5">
                                    ...
                                    <select 
                                        ...
                                        className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-none text-xs font-bold focus:bg-white focus:border-blue-600 outline-none transition-all appearance-none"
                                    >
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-1.5">
                                        ...
                                        <input 
                                            ...
                                            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-none text-xs font-bold focus:bg-white focus:border-blue-600 outline-none transition-all"
                                        />
                                    </div>
                                    <div className="space-y-1.5">
                                        ...
                                        <input 
                                            type="date" 
                                            required
                                            min={bulkForm.startDate || getTodayLocalDateString()}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 font-bold text-xs">₹</div>
                                        <input 
                                            type="number" 
                                            placeholder="Leave empty to keep existing price"
                                            value={bulkForm.price}
                                            onChange={(e) => setBulkForm({...bulkForm, price: e.target.value})}
                                            className="w-full pl-8 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-none text-xs font-bold focus:bg-white focus:border-blue-600 outline-none transition-all placeholder:text-slate-400 placeholder:text-xs"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        <button
                                            ...
                                            className={cn(
                                                "py-2.5 rounded-none text-[9px] font-black uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 cursor-pointer",
                                                !bulkForm.isBlocked ? "bg-emerald-600 text-white border-emerald-600 shadow-md shadow-emerald-100" : "bg-white text-slate-500 border-slate-200 hover:bg-slate-50"
                                            )}
                                        >
                                            <Unlock className="w-3.5 h-3.5" /> Open (Available)
                                        </button>
                                        <button
                                            type="button"
                                            ...
                                            className={cn(
                                                "py-2.5 rounded-none text-[9px] font-black uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 cursor-pointer",
                                                bulkForm.isBlocked ? "bg-red-600 text-white border-red-600 shadow-md shadow-red-100" : "bg-white text-slate-500 border-slate-200 hover:bg-slate-50"
                                            )}
                                        >
                                            <Lock className="w-3.5 h-3.5" /> Block (Sold Out)
                                        </button>
                                    </div>
                                    ...
                                    {!bulkForm.isBlocked && bulkForm.roomId && (
                                        <div className="space-y-1.5 mt-3 border-t border-slate-100 pt-3">
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-none text-xs font-bold focus:bg-white focus:border-blue-600 outline-none transition-all"
                                            />
                                            <p className="text-[9px] font-bold text-slate-400 ml-1">Max units: {rooms.find(r => r.id.toString() === bulkForm.roomId)?.totalInventory || 1}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-slate-50/50 border-t border-slate-100">
                                <button 
                                    type="submit" 
                                    disabled={isSaving}
                                    className="w-full py-3 bg-stone-900 text-white rounded-none font-black text-xs uppercase tracking-widest shadow-md hover:bg-stone-800 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                                >
