            ...
            <aside className={cn(
                ...
                <div className={cn(
                    ...
                    <button
                        ...
                        className="p-1.5 hover:bg-slate-800 rounded text-slate-400 hover:text-white transition-colors flex items-center justify-center border border-slate-800/40"
                ...
                <div className="p-4 border-t border-slate-800">
                    <button
                        ...
                        className={cn(
                            "w-full flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-red-400 text-xs font-bold uppercase tracking-wider transition-colors",
                            sidebarCollapsed ? "justify-center px-2" : "justify-start"
                        )}
