            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-8 flex items-center justify-between">
                ...
                <div className="md:hidden flex items-center gap-3">
                    <button 
                        ...
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-100 text-slate-900 border border-slate-200"
                    >
                        {user?.photoURL ? (
                    ...
                    <button
                        ...
                        className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-950 text-white"
                    >
                    ...
                    <>
                        ...
                        >
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <button onClick={() => setProfileMobileOpen(false)} className="w-10 h-10 flex items-center justify-center rounded-full bg-slate-50 text-slate-400">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
