...
export const adminApi = {
    ...
    suggestRooms: (data: { hotelId: number; prompt?: string; url?: string; history?: { role: string; text: string }[]; existingRooms?: any[] }) => apiFetch('/admin/ai/suggest-rooms', { method: 'POST', body: JSON.stringify(data) }),
};
