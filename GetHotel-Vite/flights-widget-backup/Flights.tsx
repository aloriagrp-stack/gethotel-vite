...
export default function Flights() {
  ...
  return (
    <main className="flex flex-col min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-brand-50/50 via-blue-50 to-sky-100/30 text-slate-900 py-16 px-4 md:px-8 border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-4 leading-tight text-slate-950"
          >
          ...
          >
            Get real-time airfares from hundreds of airlines and travel agents worldwide instantly.
          </motion.p>
        </div>
      </div>

      {/* Widget Container */}
      <div className="max-w-7xl mx-auto w-full px-4 md:px-8 -mt-8 pb-16 relative z-20 flex-grow">
