    ...
    useEffect(() => {
        const fetchHotel = async () => {
            try {
                ...
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/hotels/${id}`, {
    ...
    if (!hotel) {
        return (
            <div className="flex flex-col items-center justify-center py-20">
                ...
                <Link href="/admin/super" className="text-brand-600 font-bold hover:underline flex items-center gap-2">
        ...
        <div className="p-8 md:p-10">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-10">
                    <Link href="/admin/super" className="inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 font-bold text-xs uppercase tracking-widest transition-colors">
                        <ArrowLeft className="w-4 h-4" /> Back to Dashboard
                    </Link>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <div className="bg-white border border-slate-200 p-8 shadow-sm">
                            <div className="flex items-start justify-between mb-6">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-3xl font-black text-slate-900">₹{hotel.totalRevenue.toLocaleString()}</p>
                                </div>
                            </div>
                            ...
                            {/* Trust & Performance Control Hub - NEW */}
                            <div className="mt-8 p-6 bg-slate-50 border border-slate-200 rounded-3xl">
                                <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-6 flex items-center gap-2">
                                    <ShieldCheck className="w-4 h-4 text-emerald-600" /> Trust & Performance Hub
                                </h3>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-xs font-black text-emerald-600">{hotel.qualityScore || 85}%</span>
                                        </div>
                                        <input type="range" className="w-full accent-emerald-500" defaultValue={hotel.qualityScore || 85} />
                                    </div>
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center">
                                ...
                                <div className="mt-6 flex justify-end">
                                    <button className="px-6 py-2 bg-slate-900 text-white text-[9px] font-black uppercase tracking-widest rounded-xl hover:bg-black transition-all">
                            ...
                            <div className="mt-10">
                                <h3 className="text-xs font-black text-slate-900 uppercase tracking-widest mb-4 flex items-center gap-2">
                                    <Info className="w-4 h-4 text-brand-600" /> Property Description
                                </h3>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-slate-900 text-white p-8 border border-slate-800 shadow-xl">
