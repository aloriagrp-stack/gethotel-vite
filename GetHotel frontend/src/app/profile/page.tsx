...
export default function ProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-white pb-20">
            ...
            <div className="h-[350px] bg-[#F0F7FF] relative overflow-hidden border-b border-slate-100">
                ...
                <div className="max-w-6xl mx-auto px-6 pt-40 relative z-10">
                    <div className="flex flex-col md:flex-row items-center md:items-center gap-8">
                        ...
                        >
                            <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 p-1 shadow-xl relative z-10">
                                <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden relative border-4 border-white">
                                    <span className="text-4xl md:text-5xl font-black text-brand-600 uppercase italic">
                                        {heroName.charAt(0)}
                                    </span>
                                </div>
                            </div>
                            {/* Status Badge */}
                            <div className="absolute -bottom-1 -right-1 bg-emerald-500 text-white px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg border-2 border-white z-20">
                                {t('verified')}
                            </div>
                        </motion.div>
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            >
                                <h1 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight italic leading-tight mb-2 min-h-[1.2em]">
                                    {heroName}
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start gap-4">
                                    ...
                                    <div className="flex items-center gap-2 px-1">
                                        ...
                                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">India</span>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
