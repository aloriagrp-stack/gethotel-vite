            ...
            <aside className="hidden lg:flex w-72 bg-white border-r border-slate-200 flex-col fixed inset-y-0 left-0 z-50">
                <div className="p-8 border-b border-slate-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-slate-900 tracking-tight">Partner<span className="text-blue-600">Central</span></h1>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">GetHotel v2.0</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 border-t border-slate-50">
                    <button 
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3.5 text-slate-400 hover:text-red-600 font-bold text-sm transition-colors rounded-xl hover:bg-red-50"
                    >
            ...
            <div className="flex-1 lg:ml-72 flex flex-col min-h-screen">
                ...
                <header className="lg:hidden h-20 bg-white border-b border-slate-200 px-6 flex items-center justify-between sticky top-0 z-40">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-lg font-black text-slate-900">PartnerCentral</h1>
                    </div>
                    <button 
                ...
                {showLogoutConfirm && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md bg-white rounded-3xl z-[210] overflow-hidden shadow-2xl border border-slate-100"
                        >
                            <div className="p-10 text-center">
                                ...
                                <p className="text-slate-500 font-bold mb-10 leading-relaxed">
                                    Are you sure you want to logout from Partner Central?
                                </p>
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <button
                                        onClick={handleLogout}
                                        className="flex-1 py-4 bg-red-600 text-white rounded-xl font-black shadow-xl shadow-red-600/20 hover:bg-red-700 transition-all hover:scale-105 active:scale-95"
                                    >
                                        Yes, Logout
                                    </button>
                                    <button
                                        onClick={() => setShowLogoutConfirm(false)}
                                        className="flex-1 py-4 bg-slate-100 text-slate-900 rounded-xl font-black hover:bg-slate-200 transition-all active:scale-95"
                                    >
                                        No, Stay
                                    </button>
                                </div>
